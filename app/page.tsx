      ...
      <main className="flex-1">
        <section className="relative overflow-hidden">
          ...
          <div className="relative mx-auto grid w-full max-w-7xl gap-10 px-6 py-16 sm:py-20 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
            <div className="max-w-2xl">
              <p className="text-xs font-semibold uppercase tracking-[0.32em] text-amber-300">[placeholder]</p>
        ...
        <section className="mx-auto w-full max-w-7xl px-6 py-14">
          <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-5">
            {PRODUCT_CATEGORIES.map((category) => (
              ...
              >
                <p className="text-xs font-semibold uppercase tracking-[0.28em] text-slate-500">[placeholder]</p>
                ...
                <span className="mt-5 inline-flex text-sm font-medium text-[#153156] group-hover:underline">[placeholder]</span>
              </Link>
            ))}
          </div>
        </section>
        ...
        <section className="mx-auto grid w-full max-w-7xl gap-8 px-6 pb-14 lg:grid-cols-[0.9fr_1.1fr]">
          <div className="rounded-[2rem] border border-slate-200 bg-white p-6 shadow-sm">
            <p className="text-xs font-semibold uppercase tracking-[0.28em] text-slate-500">[placeholder]</p>
            <h2 className="mt-3 text-2xl font-semibold tracking-tight text-slate-950">{PRODUCT_CATEGORIES[0]?.label ?? "[placeholder]"}</h2>
        ...
        <section className="mx-auto w-full max-w-7xl px-6 pb-16">
          <div className="rounded-[2rem] border border-slate-200 bg-white p-6 shadow-sm">
            ...
            <div className="mt-3 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
              <p className="max-w-2xl text-sm leading-6 text-slate-600">[placeholder]</p>
